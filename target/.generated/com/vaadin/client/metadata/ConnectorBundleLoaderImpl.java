      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load0() {
            ...
            store.setParamTypes(org.vaadin.activelink.client.activelink.ActiveLinkServerRpc.class, "clicked", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
          ...
          private void load1() {
            ...
            store.setProxyHandler(org.vaadin.activelink.client.activelink.ActiveLinkServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new org.vaadin.activelink.client.activelink.ActiveLinkServerRpc() {
                  public void clicked(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(org.vaadin.activelink.client.activelink.ActiveLinkServerRpc.class).getMethod("clicked"), new Object [] {p0, });
                  }
                };
              }
            });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setSuperClass(org.vaadin.activelink.client.activelink.ActiveLinkState.class, com.vaadin.shared.ui.link.LinkState.class);
            ...
            store.setClass("org.vaadin.activelink.ActiveLink", org.vaadin.activelink.client.activelink.ActiveLinkConnector.class);
          ...
          private void load0() {
            ...
            store.setConstructor(org.vaadin.activelink.client.activelink.ActiveLinkConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(org.vaadin.activelink.client.activelink.ActiveLinkConnector.class);
              }
            });
            store.setConstructor(org.vaadin.activelink.client.activelink.ActiveLinkState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(org.vaadin.activelink.client.activelink.ActiveLinkState.class);
              }
            });
            store.setConstructor(org.vaadin.activelink.client.activelink.ActiveLinkWidget.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(org.vaadin.activelink.client.activelink.ActiveLinkWidget.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(org.vaadin.activelink.client.activelink.ActiveLinkConnector.class, "getState", new Type(org.vaadin.activelink.client.activelink.ActiveLinkState.class));
            store.setReturnType(org.vaadin.activelink.client.activelink.ActiveLinkConnector.class, "getWidget", new Type(org.vaadin.activelink.client.activelink.ActiveLinkWidget.class));
          ...
          private void load2() {
            ...
            store.setPropertyType(org.vaadin.activelink.client.activelink.ActiveLinkState.class, "on", new Type(java.lang.Boolean.class));
          ...
          private native void loadNativeJs0(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@org.vaadin.activelink.client.activelink.ActiveLinkState::on = value.@java.lang.Boolean::booleanValue()();
              },
              getter: function(bean) {
                return @java.lang.Boolean::valueOf(Z)(bean.@org.vaadin.activelink.client.activelink.ActiveLinkState::on);
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@org.vaadin.activelink.client.activelink.ActiveLinkState::class, 'on', data);
